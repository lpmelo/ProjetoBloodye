...
namespace ProjetoBloodye.bd {
    ...
    public partial class AdministradoresDataSet : global::System.Data.DataSet {
        ...
        public partial class AdmsDataTable : global::System.Data.TypedTableBase<AdmsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public AdmsRow FindByCódigo(int Código) {
        ...
        public partial class AdmsRow : global::System.Data.DataRow {
            ...
            public int Código {
                get {
                    return ((int)(this[this.tableAdms.CódigoColumn]));
                }
                set {
                    this[this.tableAdms.CódigoColumn] = value;
                }
            }
...
namespace ProjetoBloodye.bd.AdministradoresDataSetTableAdapters {
    ...
    public partial class AdmsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Adms` WHERE ((`Código` = ?) AND ((? = 1 AND `Nome` IS NULL) OR (`Nom" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Adms` SET `Nome` = ?, `Sobrenome` = ?, `Login` = ?, `Senha` = ?, `CPF` = ? WHERE ((`Código` = ?) AND ((? = 1 AND `Nome` IS NULL) OR (`Nome` = ?)) AND ((? = 1 AND `Sobrenome` IS NULL) OR (`Sobrenome` = ?)) AND ((? = 1 AND `Login` IS NULL) OR (`Login` = ?)) AND ((? = 1 AND `Senha` IS NULL) OR (`Senha` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Código, Nome, Sobrenome, Login, Senha, CPF FROM Adms";
        ...
        public virtual int Delete(int Original_Código, string Original_Nome, string Original_Sobrenome, string Original_Login, string Original_Senha) {
        ...
        public virtual int Update(string Nome, string Sobrenome, string Login, string Senha, string CPF, int Original_Código, string Original_Nome, string Original_Sobrenome, string Original_Login, string Original_Senha) {
            if ((Nome == null)) {
